...
// Решение задачи №14: "В массиве X(n) подсчитать количество отрицательных элементов, и изменить значение каждого положительного элемента путем его деления на значение последующего члена. Элемент Xₙ полагать заведомо отрицательным."
