...
int main() { // Объявляем главную функцию
    ...
    int num1, num2; // Объявляем переменные для хранения двух трехзначных чисел

    printf("Введите два трехзначных числа: "); // Выводим приглашение для ввода двух чисел
    scanf("%d %d", &num1, &num2); // Считываем два числа

    if (num1 % 10 == num2 / 100) { // Проверяем, равна ли последняя цифра первого числа первой цифре второго числа
        printf("Результат: %d, %d\n", num1 * 3, num2 * 3); // Если да, утраиваем каждое число
    } else {
        printf("Результат: %f\n", num1 / (double)num2); // Если нет, выводим частное первого числа и второго
    }
