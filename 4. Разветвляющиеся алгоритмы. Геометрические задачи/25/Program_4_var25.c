...
// Решение задачи №25: "Составить алгоритм и программу, проверяющую, попадает ли введенная точка с координатами (x, y) в заштрихованную фигуру."
...
int main() {
    ...
    if ( ((x <=0.0 && (x * x + y * y) <=4.0) ||
          (x >=0.0 && x <=2.0 && y >=-1.0 && y <=1.0)) ) {
