...
// Решение задачи №4: "Составить алгоритм и программу, проверяющую, попадает ли введенная точка с координатами (x, y) в заштрихованную фигуру."
...
int main() {
    ...
    if ((fabs(x) <= 3.0 && fabs(y) <= 3.0) && !(x >= 0.0 && x <= 2.0 && y >= 0.0 && y <= 2.0)) {
