...
// Решение задачи №5: "Составить алгоритм и программу, проверяющую, попадает ли введенная точка с координатами (x, y) в заштрихованную фигуру."
...
int main() {
    ...
    if ( ((x >= -3.0 && x <= 3.0) && (y >= -1.0 && y <= 1.0)) ||
         ((x >= -1.0 && x <= 1.0) && (y >= -3.0 && y <= 3.0)) ) {
