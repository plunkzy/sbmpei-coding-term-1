...
int main() {
    ...
    // Первый прямоугольник: x от -3 до 3, y от -1 до 1
    // Второй прямоугольник: x от -1 до 1, y от -3 до 3
    if ( ((x >= -3.0 && x <= 3.0) && (y >= -1.0 && y <= 1.0)) || // Первый прямоугольник
         ((x >= -1.0 && x <= 1.0) && (y >= -3.0 && y <= 3.0)) ) { // Второй прямоугольник
