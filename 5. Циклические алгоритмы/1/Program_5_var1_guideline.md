...
int main() { // Объявляем главную функцию
    ...
    double miles, kilometers; // Объявляем переменные для миль и километров
    int i; // Объявляем переменную счетчика цикла

    printf("Мили\tКилометры\n"); // Выводим заголовок таблицы
    printf("---------------------\n"); // Выводим разделительную линию

    for(i = 1; i <= 50; i++) { // Запускаем цикл от 1 до 50 миль
        miles = i; // Присваиваем текущую милю переменной miles
        kilometers = miles * 1.609344; // Пересчитываем мили в километры
        printf("%d\t%.6lf\n", i, kilometers); // Выводим значения миль и километров
    }
