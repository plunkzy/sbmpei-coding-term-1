...
int main() { // Объявляем главную функцию
    ...
    int N; // Объявляем переменную для ввода числа N
    long long sum = 0; // Инициализируем переменную для суммы квадратов

    printf("Введите натуральное число N: "); // Запрашиваем ввод числа N
    ...
    for(int i = 1; i <= N; i++) { // Запускаем цикл от 1 до N для вычисления суммы квадратов
        sum += (long long)i * i; // Добавляем квадрат текущего числа к сумме
    }

    printf("Сумма квадратов чисел от 1 до %d равна %lld.\n", N, sum); // Выводим результат суммы квадратов
