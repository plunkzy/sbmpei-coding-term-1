...
int main() { // Объявляем главную функцию
    ...
    int N, square = 0; // Объявляем переменные для числа N и суммы для вычисления квадрата

    printf("Введите натуральное число N (> 0): "); // Запрашиваем ввод числа N
    ...
    for(int i = 1; i <= 2*N-1; i += 2) { // Запускаем цикл от 1 до (2N-1) с шагом 2 для суммирования нечетных чисел
        square += i; // Добавляем текущий нечетный элемент к сумме
    }

    printf("Квадрат числа %d равен %d.\n", N, square); // Выводим результат
