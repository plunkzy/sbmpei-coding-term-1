...
int main() { // Объявляем главную функцию
    ...
    int positive_count = 0, negative_count = 0; // Инициализируем счетчики положительных и отрицательных чисел
    ...
    for(int i = 1; i <= N; i++) { // Запускаем цикл для ввода N чисел
        ...
        if(number > 0) { // Если число положительное
            positive_count++; // Увеличиваем счетчик положительных чисел
        } else if(number < 0) { // Если число отрицательное
            negative_count++; // Увеличиваем счетчик отрицательных чисел
        }
        // Если число равно нулю, не учитываем его
    }

    printf("Количество положительных чисел: %d\n", positive_count); // Выводим количество положительных чисел
    printf("Количество отрицательных чисел: %d\n", negative_count); // Выводим количество отрицательных чисел
