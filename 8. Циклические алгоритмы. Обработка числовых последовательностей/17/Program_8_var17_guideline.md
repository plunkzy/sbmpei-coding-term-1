...
int main() { // Объявляем главную функцию
    ...
    int sum = 0; // Инициализируем сумму чисел
    int message_printed = 0; // Флаг, указывающий на вывод сообщения о превышении суммы
    ...
    for(int i = 1; i <= N; i++) { // Запускаем цикл для ввода N чисел
        ...
        if(!message_printed && sum > 100) { // Проверяем, превышает ли сумма 100 и сообщение еще не выведено
            printf("Сумма чисел превысила 100.\n"); // Выводим сообщение
            message_printed = 1; // Устанавливаем флаг, что сообщение уже выведено
        }
    }

    if(!message_printed) { // Если сумма не превысила 100
