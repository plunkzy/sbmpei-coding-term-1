...
int main() { // Объявляем главную функцию
    ...
    int count = 0; // Инициализируем счетчик случаев, когда номер числа больше его значения
    ...
    for(int i = 1; i <= N; i++) { // Запускаем цикл для ввода N чисел
        ...
        if(i > number) { // Проверяем, больше ли номер числа его значение
            count++; // Увеличиваем счетчик случаев
        }
    }
