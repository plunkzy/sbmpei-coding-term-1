...
int main() { // Объявляем главную функцию
    ...
    int count_mult_5 = 0; // Инициализируем счетчик чисел, кратных 5
    ...
    for(int i = 1; i <= N; i++) { // Запускаем цикл для ввода N чисел
        ...
        if(number % 5 == 0) { // Проверяем, кратно ли число 5
            count_mult_5++; // Увеличиваем счетчик кратных 5 чисел
        }
    }

    printf("Количество чисел, кратных 5: %d\n", count_mult_5); // Выводим результат подсчета
