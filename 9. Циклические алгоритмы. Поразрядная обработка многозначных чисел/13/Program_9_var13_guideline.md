...
int main() { // Объявляем главную функцию
    ...
    int increasing = 1; // Флаг, указывающий на порядок возрастания цифр
    ...
    while(N > 0) { // Пока число больше нуля
        ...
        if(previous_digit != -1 && digit >= previous_digit) { // Проверяем, нарушается ли порядок возрастания
            increasing = 0; // Устанавливаем флаг отсутствия возрастания
    ...
    if(increasing) { // Если порядок возрастания соблюден
        printf("Цифры числа расположены в порядке возрастания.\n"); // Выводим соответствующее сообщение
    } else { // Если порядок возрастания нарушен
