...
int main() { // Объявляем главную функцию
    ...
    int non_zero_count = 0; // Инициализируем счетчик цифр, не равных нулю
    ...
    while(N > 0) { // Пока число больше нуля
        ...
        if(digit != 0) { // Проверяем, не равна ли цифра нулю
            non_zero_count++; // Увеличиваем счетчик нечетных цифр
        }
        N /= 10; // Удаляем последнюю цифру числа
    }

    printf("Количество цифр, не равных нулю: %d\n", non_zero_count); // Выводим результат подсчета
