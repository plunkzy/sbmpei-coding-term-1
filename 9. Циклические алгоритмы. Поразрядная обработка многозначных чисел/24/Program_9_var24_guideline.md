...
int main() { // Объявляем главную функцию
    ...
    int decreasing = 1; // Флаг, указывающий на порядок убывания цифр
    ...
    while(N > 0) { // Пока число больше нуля
        ...
        if(prev_digit != -1 && digit < prev_digit) { // Проверяем, нарушается ли порядок убывания
    ...
    if(decreasing) { // Если порядок убывания соблюден
        printf("Цифры числа расположены в порядке убывания.\n"); // Выводим соответствующее сообщение
    } else { // Если порядок убывания нарушен
